<nav class="bg-[#d67316] border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
          ...
          >
            <div class="py-3 px-4">
              ...
              <span
                ...
                ><?= htmlspecialchars($_SESSION['user_email']) ?></span
              >
            </div>
            <ul
